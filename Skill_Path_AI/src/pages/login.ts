...
export function login(): string {
  ...
  return royalHead('Log In — SkillPath AI') + `
...
.form-input:focus {
  outline: none; border-color: rgba(37, 99, 235, 0.5);
...
.auth-forgot a {
  font-size: 13px; font-weight: 500; color: var(--royal-blue-light); text-decoration: none;
}
.auth-forgot a:hover { text-decoration: underline; color: #fff; }
...
.auth-footer a {
  color: var(--royal-blue-light); font-weight: 600; text-decoration: none;
}
...
<div class="auth-container">
  ...
  <div class="auth-card">
    <div class="auth-header">
      ...
      <p class="auth-subtitle">Log in to view your personalized learning roadmaps.</p>
    </div>
    ...
    <div class="auth-divider">
      ...
      <div class="auth-divider-text">Or continue with email</div>
      <div class="auth-divider-line"></div>
    </div>
